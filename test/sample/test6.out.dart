...
User get creator=>_$accessor_2$_.get(this[r'creator']);
  ...
  @override
  final $container$ = {};
static final DateTimeMillisecondsAccessor _$accessor_1$_ = new DateTimeMillisecondsAccessor();static final UserParamsModelAccessor _$accessor_2$_ = new UserParamsModelAccessor();static final ToStringJSONEncoder _$json_encoder_0$_ = new ToStringJSONEncoder();dynamic toJson(){var _$$tmp_$$_;var _$$result_$$_ = {};_$$tmp_$$_ = (title);if (_$$tmp_$$_!=null){_$$result_$$_[r'title']=_$$tmp_$$_;}_$$tmp_$$_ = _$json_encoder_0$_.encode(create);if (_$$tmp_$$_!=null){_$$result_$$_[r'create']=_$$tmp_$$_;}_$$tmp_$$_ = (creator!=null?creator.toJson():null);if (_$$tmp_$$_!=null){_$$result_$$_[r'creator']=_$$tmp_$$_;}return _$$result_$$_;}}
...
dynamic toJson(){var _$$tmp_$$_;var _$$result_$$_ = {r'sName': (sName)};_$$tmp_$$_ = (firstName);if (_$$tmp_$$_!=null){_$$result_$$_[r'firstName']=_$$tmp_$$_;}_$$tmp_$$_ = (lastName);if (_$$tmp_$$_!=null){_$$result_$$_[r'lastName']=_$$tmp_$$_;}return _$$result_$$_;}}