...
String get title=>(this[r'title']);
  ...
  set create(DateTime value)=>this[r'create']=_$accessor_0$_.set(value);
DateTime get create=>_$accessor_0$_.get(this[r'create']);

  set creator(User value)=>this[r'creator']=_$accessor_1$_.set(value);
User get creator=>_$accessor_1$_.get(this[r'creator']);

  @override
  final $container$ = {};
static final DateTimeMillisecondsAccessor _$accessor_0$_ = new DateTimeMillisecondsAccessor();static final UserParamsModelAccessor _$accessor_1$_ = new UserParamsModelAccessor();static final ToStringJSONEncoder _$json_encoder_0$_ = new ToStringJSONEncoder();Map<String, dynamic> toJson([Map<String, dynamic> _$$result_$$_]){var _$$tmp_$$_;if (_$$result_$$_ == null){ _$$result_$$_ = new Map<String, dynamic>();}_$$tmp_$$_ = (title);if (_$$tmp_$$_!=null){_$$result_$$_[r'title']=_$$tmp_$$_;}_$$tmp_$$_ = _$json_encoder_0$_.encode(create);if (_$$tmp_$$_!=null){_$$result_$$_[r'create']=_$$tmp_$$_;}_$$tmp_$$_ = (creator!=null?creator.toJson():null);if (_$$tmp_$$_!=null){_$$result_$$_[r'creator']=_$$tmp_$$_;}return super.toJson(_$$result_$$_);}}
